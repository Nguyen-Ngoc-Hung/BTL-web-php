...
<body>
    ...
    <ul>Menu
        <li><a href="">Tất cả các bài viết</a></li>
        <li><a href="">Bài viết đã được duyệt</a></li>
        <li><a href="">Tất cả các bài viết</a></li>
        <li><a href="">Bài viết không được duyệt</a></li>
    ...
    <div class="center">
        ...
        $sql = "SELECT `id`, `title`, `summary`, `link_image`, `content`, `arthur`, `date`, `views` FROM `news` WHERE `arthur`='$id' and approved=1";
